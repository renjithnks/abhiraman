		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'abhiraman' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'abhiraman' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'abhiraman' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'abhiraman' ),
						'full'    => esc_html__( 'Full text', 'abhiraman' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-abhiraman-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			...
			$wp_customize->add_control(
				new Abhiraman_Customize_Color_Control(
					...
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'abhiraman' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
