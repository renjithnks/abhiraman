...
if ( ! class_exists( 'Abhiraman_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Abhiraman 1.0
	 */
	class Abhiraman_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'abhiraman_child' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'abhiraman_child' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'abhiraman_child' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'abhiraman_child' ),
						'full'    => esc_html__( 'Full text', 'abhiraman_child' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-abhiraman-child-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'Abhiraman_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Abhiraman_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'abhiraman_child' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
